package cn.edu.gdmec.chaos07150844.myweather;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initProvinces();
        initChooseDialog();
        settingbutton = (ImageButton) this.findViewById(R.id.setting);
        refresBtn = (ImageButton) this.findViewById(R.id.refresh);
        ...
        refresBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    private class ChooseCityListenner implements DialogInterface.OnClickListener {
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            TextView cityNmae = (TextView) seft.findViewById(R.id.city);
            cityNmae.setText(city_name);
